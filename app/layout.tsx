...
export const metadata: Metadata = {
  ...
  title: "AnswerLoops",
  description:
    "Someone in your community asks a question you've already answered. AnswerLoops answers it again, right in your community channel — Discord, Slack, Discourse and Circle forums, GitHub, Telegram, email, and website chat — grounded in your knowledge, and only when it's confident enough to be right. Open source, self-hosted, and MCP/API-ready.",
  openGraph: {
    type: 'website',
    siteName: 'AnswerLoops',
    title: 'AnswerLoops — Support that lives in your community',
    description:
      "Your community keeps asking questions you've already answered. AnswerLoops remembers, and answers them again in your community channel — Discord, Slack, GitHub, and more — with confidence-gated automation. Open source, self-hosted, and MCP/API-ready.",
