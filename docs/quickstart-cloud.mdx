...
<CardGroup cols={2}>
  <Card title="AI Configuration" icon="sliders" href="/product/ai-config">
    Switch AI providers or tune the confidence threshold
  </Card>
  <Card title="Knowledge Gaps" icon="circle-question" href="/product/knowledge-gaps">
    See what questions the AI couldn't answer and close the gaps
  </Card>
  <Card title="Escalation" icon="bell" href="/product/escalation">
    Route low-confidence tickets to a human support role
  </Card>
  <Card title="Invite your team" icon="users" href="/product/team">
