...
If you'd rather skip all of this, the [cloud quickstart](/quickstart-cloud) gets you the same product with none of the infrastructure.
...
- An AI provider key (OpenAI recommended, or any [supported provider](/self-hosting/ai-providers))
...
<CardGroup cols={2}>
  <Card title="Discord Bot" icon="discord" href="/self-hosting/discord-bot">
    Set up the Discord integration
  </Card>
  <Card title="Slack App" icon="slack" href="/self-hosting/slack-app">
    Set up Slack polling or OAuth
  </Card>
  <Card title="GitHub App" icon="github" href="/integrations/github">
    Ingest Issues and Discussions
  </Card>
  <Card title="Deploy to Production" icon="rocket" href="/self-hosting/production">
