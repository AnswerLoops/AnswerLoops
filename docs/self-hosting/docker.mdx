...
Everything here assumes you've already cloned the repo and filled in a real `.env.local` — see the [self-host quickstart](/quickstart-self-host) if you haven't done that part yet. Docker Compose reads that file; it doesn't generate secrets or register OAuth apps for you.
