...
Gather these before you start the [self-host quickstart](/quickstart-self-host) — nothing below takes long to get, but bouncing between OAuth app dashboards mid-setup is the most common source of "why isn't this working."
...
| Stripe | Billing / plan enforcement (only relevant if you're running this as a paid product yourself) |
