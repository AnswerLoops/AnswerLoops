...
This assumes you've already worked through the [self-host quickstart](/quickstart-self-host) locally and know your setup works — production is the same app, just with real secrets, a real domain, and `docker-compose.prod.yml` instead of the dev compose file.
