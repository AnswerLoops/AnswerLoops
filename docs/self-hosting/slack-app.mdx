...
```bash
SLACK_CLIENT_ID=1234567890.987654321098
...
Regardless of connection method, invite the bot to each channel you want monitored:

```
/invite @YourBotName
```

Or use the channel picker in **Settings → Integrations → Slack** after connecting.
